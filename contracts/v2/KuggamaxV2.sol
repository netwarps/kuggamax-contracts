...
import "./Token1155V2.sol";


contract KuggamaxV2 is Initializable, ContextUpgradeable, EIP712Upgradeable, OwnableUpgradeable {
...
//    }
    ...
    uint256[39] private __gap; // storage gap for upgrading
}
