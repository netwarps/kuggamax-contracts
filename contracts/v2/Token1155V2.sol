...
contract Token1155V2 is IToken1155, ERC1155BurnableUpgradeable, ERC1155SupplyUpgradeable, OwnableUpgradeable {
    //constructor() ERC1155("") {
    ...
    uint256[49] private __gap; // storage gap for upgrading
}
